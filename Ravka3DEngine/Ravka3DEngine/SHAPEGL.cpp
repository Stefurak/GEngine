...
namespace Ravka3DEngine
{
	...
	//void SHAPEGL::drawModel()
	//{
	//	m_mesh.drawModel();
	//}

	SHAPEGL SHAPEGL::createShape(
		ShapeType type,
		float size,
		...
		glm::vec4 * colourData /* nullptr */)
	{
		...
		case CUBE:
			...
			break;
		case COLOURED_CUBE:
			this->setVertices(createColouredCube(size, texturing, colourData));
			break;
		case PYRAMID:
		...
		this->setMesh(MESHGL(this->m_vertices, this->m_vertices.size()));

		return *(this);
	}

	//SHAPEGL SHAPEGL::createModel(Model3D indexedModel)
	//{
	//	Mesh mesh(indexedModel);
	//
	...
	std::vector<Vertex> SHAPEGL::createPyramid(float size, float texturing)
	{
	...
	std::vector<Vertex> SHAPEGL::createCube(float size, float texturing)
	{
		auto tex = texturing / 2.0f;
	...
	std::vector<Vertex> SHAPEGL::createColouredCube(float size, float texturing, glm::vec4 * colourData)
	{
		auto tex = texturing / 2.0f;
		...
		vertices.emplace_back(glm::vec3(-size, size, -size), glm::vec2(0.0f), frontNormal, colourData[0]);
		vertices.emplace_back(glm::vec3(-size), glm::vec2(tex, texturing), frontNormal, colourData[0]);
		vertices.emplace_back(glm::vec3(size, -size, -size), glm::vec2(texturing, 0.0f), frontNormal, colourData[0]);
		vertices.emplace_back(glm::vec3(size, -size, -size), glm::vec2(0.0f), frontNormal, colourData[0]);
		vertices.emplace_back(glm::vec3(size, size, -size), glm::vec2(tex, texturing), frontNormal, colourData[0]);
		vertices.emplace_back(glm::vec3(-size, size, -size), glm::vec2(texturing, 0.0f), frontNormal, colourData[0]);

		/* LEFT */

		vertices.emplace_back(glm::vec3(-size, -size, size), glm::vec2(0.0f), -rightNormal, colourData[1]);
		vertices.emplace_back(glm::vec3(-size), glm::vec2(tex, texturing), -rightNormal, colourData[1]);
		vertices.emplace_back(glm::vec3(-size, size, -size), glm::vec2(texturing, 0.0f), -rightNormal, colourData[1]);
		vertices.emplace_back(glm::vec3(-size, size, -size), glm::vec2(0.0f), -rightNormal, colourData[1]);
		vertices.emplace_back(glm::vec3(-size, size, size), glm::vec2(tex, texturing), -rightNormal, colourData[1]);
		vertices.emplace_back(glm::vec3(-size, -size, size), glm::vec2(texturing, 0.0f), -rightNormal, colourData[1]);

		/* RIGHT */

		vertices.emplace_back(glm::vec3(size, -size, -size), glm::vec2(0.0f), rightNormal, colourData[2]);
		vertices.emplace_back(glm::vec3(size, -size, size), glm::vec2(tex, texturing), rightNormal, colourData[2]);
		vertices.emplace_back(glm::vec3(size), glm::vec2(texturing, 0.0f), rightNormal, colourData[2]);
		vertices.emplace_back(glm::vec3(size), glm::vec2(0.0f), rightNormal, colourData[2]);
		vertices.emplace_back(glm::vec3(size, size, -size), glm::vec2(tex, texturing), rightNormal, colourData[2]);
		vertices.emplace_back(glm::vec3(size, -size, -size), glm::vec2(texturing, 0.0f), rightNormal, colourData[2]);

		/* BACK */

		vertices.emplace_back(glm::vec3(-size, -size, size), glm::vec2(0.0f), -frontNormal, colourData[3]);
		vertices.emplace_back(glm::vec3(-size, size, size), glm::vec2(tex, texturing), -frontNormal, colourData[3]);
		vertices.emplace_back(glm::vec3(size), glm::vec2(texturing, 0.0f), -frontNormal, colourData[3]);
		vertices.emplace_back(glm::vec3(size), glm::vec2(0.0f), -frontNormal, colourData[3]);
		vertices.emplace_back(glm::vec3(size, -size, size), glm::vec2(tex, texturing), -frontNormal, colourData[3]);
		vertices.emplace_back(glm::vec3(-size, -size, size), glm::vec2(texturing, 0.0f), -frontNormal, colourData[3]);

		/* BOTTOM */

		vertices.emplace_back(glm::vec3(-size, size, -size), glm::vec2(0.0f), -topNormal, colourData[4]);
		vertices.emplace_back(glm::vec3(size, size, -size), glm::vec2(tex, texturing), -topNormal, colourData[4]);
		vertices.emplace_back(glm::vec3(size), glm::vec2(texturing, 0.0f), -topNormal, colourData[4]);
		vertices.emplace_back(glm::vec3(size), glm::vec2(0.0f), -topNormal, colourData[4]);
		vertices.emplace_back(glm::vec3(-size, size, size), glm::vec2(tex, texturing), -topNormal, colourData[4]);
		vertices.emplace_back(glm::vec3(-size, size, -size), glm::vec2(texturing, 0.0f), -topNormal, colourData[4]);

		/* TOP */

		vertices.emplace_back(glm::vec3(-size), glm::vec2(0.0f), topNormal, colourData[5]);
		vertices.emplace_back(glm::vec3(-size, -size, size), glm::vec2(tex, texturing), topNormal, colourData[5]);
		vertices.emplace_back(glm::vec3(size, -size, -size), glm::vec2(texturing, 0.0f), topNormal, colourData[5]);
		vertices.emplace_back(glm::vec3(size, -size, -size), glm::vec2(0.0f), topNormal, colourData[5]);
		vertices.emplace_back(glm::vec3(-size, -size, size), glm::vec2(tex, texturing), topNormal, colourData[5]);
		vertices.emplace_back(glm::vec3(size, -size, size), glm::vec2(texturing, 0.0f), topNormal, colourData[5]);
	...
	std::vector<Vertex> SHAPEGL::createCuboid(float width, float height, float depth, float texturing)
	{
		auto tex = texturing / 2.0f;
	...
	std::vector<Vertex> SHAPEGL::createSphere(float Radius, int Resolution, bool InvertNormals)
	{
	...
	std::vector<Vertex> SHAPEGL::createPlane(float size, float texturing)
	{
	...
	std::vector<Vertex> SHAPEGL::createSkyCube(float size, float texturing)
	{
	...
	glm::vec3 SHAPEGL::computePlaneNormal(glm::vec3 pointA, glm::vec3 pointB, glm::vec3 pointC)
	{
